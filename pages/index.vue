  ...
  <section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="relative">
        ...
        <div
          class="hidden lg:block absolute top-24 left-0 right-0 h-0.5 bg-gradient-to-r from-purple-100 via-purple-500 to-purple-100"
        ></div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
          <div class="text-center mb-6">
            <div
              class="w-12 h-12 mx-auto mb-4 flex items-center justify-center bg-purple-100 rounded-xl"
            >
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between mb-12">
        ...
        <Button variant="outline" as-child>
          <NuxtLink to="/cities" class="flex items-center gap-2">
            View All Cities
        ...
        <div class="hidden md:block">
          <div class="grid grid-cols-2 gap-4 relative">
            <div class="space-y-4">
              ...
              >
                <div
                  class="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center mb-3"
                >
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li>
                <NuxtLink to="/press" class="hover:text-white transition-colors"
                  >Press</NuxtLink
                >
              </li>
            </ul>
          ...
          <div>
            ...
            <div class="mt-4">
              <Button
                variant="outline"
                class="border-white/20 hover:border-white/40 bg-white/5 hover:bg-black/10 hover:text-white"
                size="sm"
                as-child
              >
                <a
